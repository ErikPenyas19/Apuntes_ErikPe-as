...
- _**size**_: Ajustar el tamaño del texto. Al poner dicho atributo preguntará la medida deseada, si lo quiere a **50px**(pixeles), **20%**(porcentaje del texto)...
- _**width**_: Ajustar la anchura de una foto. Al poner dicho atributo preguntará la medida deseada, si lo quiere a **50px**(pixeles), **20%**(porcentaje de la imagen)...
- _**height**_: Ajustar la altura de una foto. Al poner dicho atributo preguntará la medida deseada, si lo quiere a **50px**(pixeles), **20%**(porcentaje de la imagen)...
- _**background-color**_: Decidir el color de fondo.
- _**font-family**_: Decidir la fuente de letra. Se deberá importar primero el tipo de fuente.
